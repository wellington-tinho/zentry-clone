...
export function AccordionScroll() {
  ...
  return (
    ...
    >
      <li className="text-xs sm:text-sm w-full sm:w-80 lg:w-96 cursor-pointer" onClick={RemoveHidden}>
        <div className="font-semibold flex gap-6 sm:gap-8 lg:gap-12 text-sm sm:text-base lg:text-lg items-center">
          ...
          <p className="text-xs sm:text-sm lg:text-base">Shaping Zentry Collectively</p>
        </div>
      ...
      <li className="text-xs sm:text-sm w-full sm:w-80 lg:w-96 cursor-pointer" onClick={RemoveHidden}>
        <div className="font-semibold flex gap-6 sm:gap-8 lg:gap-12 text-sm sm:text-base lg:text-lg items-center">
          ...
          <p className="text-xs sm:text-sm lg:text-base">Unlocking Economic Opportunity</p>
        </div>
        <span className="relative block ml-12 sm:ml-14 lg:ml-16 text-xs text-justify w-auto">
      ...
      <li className="text-xs sm:text-sm w-full sm:w-80 lg:w-96 cursor-pointer" onClick={RemoveHidden}>
        <div className="font-semibold flex gap-6 sm:gap-8 lg:gap-12 text-sm sm:text-base lg:text-lg items-center">
          ...
          <p className="text-xs sm:text-sm lg:text-base">Sharing Value Accrued</p>
        </div>
        <span className="relative block ml-12 sm:ml-14 lg:ml-16 text-xs text-justify w-auto">
