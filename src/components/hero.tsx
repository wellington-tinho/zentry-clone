			...
			<div className="relative overflow-hidden">
				<div className="min-h-screen w-screen" id="video-frame">
					...
					<DivWithMouseInteractionEffects
						sensitivity={5}
						className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] w-32 h-32 sm:w-48 sm:h-48 lg:w-64 lg:h-64 cursor-pointer overflow-hidden rounded-lg z-20"
					>
