...
import { FaBars, FaLocationArrow, FaTimes } from "react-icons/fa";
			...
			timeoutId = setTimeout(
				() => {
					if (zentryMusicAudioElementRef.current) {
						zentryMusicAudioElementRef.current.src = "/audio/music_loop_1.mp3";
						zentryMusicAudioElementRef.current.play(); // recomeça o novo áudio
					}
				},
				(60 + 12) * 1000,
			); // 72 segundos em milissegundos
		} else {
